...
export default function DocumentCard({ doc, onOpenDetail, index = 0 }: Props) {
  return (
    <article
      className="t-reveal flex h-full flex-col rounded-xl border border-white/70 bg-white/80 p-5 shadow-sm ring-1 ring-black/5 backdrop-blur-sm transition duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-md"
